...
const mod = {
	...
	commands: [
		{command: "w", usage: "Get the weather for your saved location: $w set <location>; $w <user>; $w", callback: (e)=>{
				...
				p.httpGet("https://api.openweathermap.org/data/3.0/onecall?lat=" + locations[wu[0]].centroid_latitude + "&lon=" + locations[wu[0]].centroid_longitude + "&appid=1d593902dc23b21ceb20eda0053d4c8c", (a)=>{
					try{
						a = JSON.parse(a);
