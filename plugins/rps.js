	...
	hook_commands: [
		{command: "rps", usage: "Starts a game of rock–paper–scissors. Example usage: .rps duckgoose", callback: (e)=>{
			...
			if(e.args.length > 1){
				...
				e.reply( e.args[1] + " & " + e.from.nick + ": Make your choice by sending /notice bark [r|p|s]");
